FUNCTION(GET_FILE_VERSION FILE_NAME FILE_VERSION)
  ...
  IF(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/../.git)
    EXECUTE_PROCESS(COMMAND git --git-dir=${CMAKE_CURRENT_SOURCE_DIR}/../.git --work-tree=${CMAKE_CURRENT_SOURCE_DIR}/../ rev-list HEAD --count -- ${FILE_NAME} 
      OUTPUT_VARIABLE FV)
    STRING(REPLACE "\n" "" FV ${FV})
...
MACRO(SET_VERSION_INFO)
  ...
  FOREACH(PROPERTY ${ARGN})
    ...
    ENDIF()
  ENDFOREACH()
  CONFIGURE_FILE(${CMAKE_CURRENT_SOURCE_DIR}/../win/resource.rc.in
                ${CMAKE_CURRENT_SOURCE_DIR}/../win/${TARGET}.rc)
  SET(${TARGET}_RC ${CMAKE_CURRENT_SOURCE_DIR}/../win/${TARGET}.rc)
ENDMACRO()
